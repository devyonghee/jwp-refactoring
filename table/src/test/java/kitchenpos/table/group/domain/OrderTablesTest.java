package kitchenpos.table.group.domain;
...
import kitchenpos.table.table.domain.Headcount;
import kitchenpos.table.table.domain.OrderTable;
import kitchenpos.table.table.sample.OrderTableSample;
...
class OrderTablesTest {
    ...
    void notHaveGroupAndEmpty() {
        //given
        OrderTables orderTables = OrderTables.from(Collections.singletonList(
            OrderTableSample.빈_두명_테이블()));
    ...
    void notHaveGroupAndEmpty_oneFull() {
        //given
        OrderTables orderTables = OrderTables.from(Arrays.asList(OrderTableSample.빈_두명_테이블(), OrderTableSample
            .채워진_다섯명_테이블()));

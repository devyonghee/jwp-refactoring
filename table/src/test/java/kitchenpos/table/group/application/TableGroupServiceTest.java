...
import static kitchenpos.table.table.sample.OrderTableSample.빈_두명_테이블;
import static kitchenpos.table.table.sample.OrderTableSample.빈_세명_테이블;
import static kitchenpos.table.table.sample.OrderTableSample.채워진_다섯명_테이블;
...
import kitchenpos.table.group.sample.TableGroupSample;
...
class TableGroupServiceTest {
    ...
    void create() {
        ...
        TableGroup 두명_세명_테이블_그룹 = TableGroupSample.두명_세명_테이블_그룹();
    ...
    void create_hasGroup_thrownException() {
        ...
        OrderTable 빈_두명_테이블 = 빈_두명_테이블();
        when(tableQueryService.table(firstOrderTableId)).thenReturn(빈_두명_테이블);
        OrderTable 그룹이_지정된_테이블 = TableGroupSample.두명_세명_테이블_그룹().orderTables().get(0);
        when(tableQueryService.table(secondOrderTableId))
    ...
    private void requestedTableGroupSave() {
        ...
        Assertions.assertThat(tableGroup.orderTables())

package kitchenpos.table.table;


import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_목록_조회_요청;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_목록_조회됨;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_빈_상태_수정_요청;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_빈_상태_수정됨;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_상태_수정됨;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_생성_요청;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_생성됨;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_손님_수_수정_요청;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_손님_수_수정됨;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_완료된_상태_수정_요청;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_저장되어_있음;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_조회_요청;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_조회됨;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_주문_받은_상태_되어_있음;
import static kitchenpos.table.table.step.TableAcceptanceStep.테이블_주문_받은_상태_수정_요청;

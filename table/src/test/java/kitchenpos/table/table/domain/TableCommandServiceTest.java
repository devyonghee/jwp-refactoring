...
class TableCommandServiceTest {
    ...
    void save() {
        //given
        OrderTable 빈_세명_테이블 = OrderTableSample.빈_세명_테이블();
    ...
    void changeEmpty() {
        //given
        OrderTable 채워진_다섯명_테이블 = OrderTableSample.채워진_다섯명_테이블();
    ...
    void changeEmpty_existTableGroupId_thrownException() {
        //given
        OrderTable 빈_두명_테이블 = OrderTableSample.빈_두명_테이블();
        OrderTable 빈_세명_테이블 = OrderTableSample.빈_세명_테이블();
    ...
    void changeEmpty_ordered_thrownException() {
        //given
        OrderTable orderTable = OrderTableSample.채워진_다섯명_테이블();
        orderTable.ordered();

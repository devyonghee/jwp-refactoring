...
import kitchenpos.order.order.domain.OrderCommandService;
import kitchenpos.order.order.domain.OrderLineItem;
import kitchenpos.order.order.domain.OrderQueryService;
import kitchenpos.order.order.domain.OrderStatus;
import kitchenpos.order.order.sample.OrderSample;
...
import kitchenpos.order.product.domain.Menu;
import kitchenpos.order.product.domain.MenuQueryService;
...
class OrderServiceTest {
    ...
    void create() {
        ...
        Order 조리중인_후라이트치킨세트_두개_주문 = OrderSample.조리중인_후라이트치킨세트_두개_주문();

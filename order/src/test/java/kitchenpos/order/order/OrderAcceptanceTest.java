package kitchenpos.order.order;

import static kitchenpos.order.order.step.OrderAcceptanceStep.주문_등록_되어_있음;
import static kitchenpos.order.order.step.OrderAcceptanceStep.주문_등록_됨;
import static kitchenpos.order.order.step.OrderAcceptanceStep.주문_등록_요청;
import static kitchenpos.order.order.step.OrderAcceptanceStep.주문_목록_조회_됨;
import static kitchenpos.order.order.step.OrderAcceptanceStep.주문_목록_조회_요청;
import static kitchenpos.order.order.step.OrderAcceptanceStep.주문_상태_수정_됨;
import static kitchenpos.order.order.step.OrderAcceptanceStep.주문_상태_수정_요청;
...
import kitchenpos.order.AcceptanceTest;
import kitchenpos.order.order.domain.OrderStatus;
import kitchenpos.order.order.ui.response.OrderResponse;
import kitchenpos.order.product.infrastructure.MenuClient;
import kitchenpos.order.product.infrastructure.dto.MenuDto;
import kitchenpos.order.table.infrastructure.OrderTableClient;
import kitchenpos.order.table.infrastructure.dto.OrderTableDto;
